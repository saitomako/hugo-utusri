...
$toemails[] = array(
                'email' => 'saitomako@gmail.com', // Your Email Address
                'name' => 'Makoto Saito' // Your Name
            );

$toemails[] = array(
                'email' => 'mako.yorii@gmail.com', // Your Email Address
                'name' => 'Mako Yorii' // Your Name
            );
...
$fromemail = array(
                'email' => 'sales@utsuri.jp', // Company's Email Address (preferably currently used Domain Name)
                'name' => 'utsuri.jp' // Company Name
            );
...
$recaptcha_secret = '6LeDSssZAAAAAF1ZcVhWDbC4_K2AixXUbtOOfoLQ'; // Your reCaptcha Secret
...
$message = array(
    'success'           => 'お問合わせありがとうございます。メッセージは正しく送信されました。近日中に折り返しご連絡を差し上げます。',
    'error'             => 'メッセージ送信時にエラーが発生しました。しばらく時間をあけて、再度お試しください。',
    'error_bot'         => 'Bot Detected! Form could not be processed! Please Try Again!',
    'error_unexpected'  => '<strong>予期しないエラー</strong>が発生しました。しばらく時間をあけて、再度お試しください。',
...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
    ...
    $html_title = !empty( $submits['html_title'] ) ? $submits['html_title'] : 'utsuri.jpよりお問い合わせがありました';
    ...
    $mail->Subject = !empty( $submits['subject'] ) ? $submits['subject'] : 'utsuri.jpよりお問い合わせがありました';
    ...
    if( $autores && !empty( $replyto_e ) ) {
        ...
        $mail->SMTPSecure = 'tls';
        $mail->SMTPAuth = true;
        $mail->Username = "saitomako@gmail.com";
        $mail->Password = "kl7EU99Bd1m00GK235";
        */
